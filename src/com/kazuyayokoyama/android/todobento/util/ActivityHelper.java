 ...
 *   - Removed search action
 *   - Changed action bar behavior
 */
...
import com.kazuyayokoyama.android.todobento.ui.HomeActivity;
...
public class ActivityHelper {
    ...
    /**
     * Invoke "info" action, triggering a default info.
     */
    public void goInfoDetails() {
    ...
    public void setupActionBar(CharSequence title, int color) {
        ...
        if (title != null) {
            // Add Home button
            addActionButtonCompat(R.drawable.ic_menu_home, R.string.description_home,
